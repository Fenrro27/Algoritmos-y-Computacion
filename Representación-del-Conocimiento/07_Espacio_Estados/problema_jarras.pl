% ===================================================================
% Ejercicio: problema_jarras.pl
% Descripcion: Resuelve el problema clasico de las jarras de agua de capacidades X e Y mediante busqueda en espacio de estados.
