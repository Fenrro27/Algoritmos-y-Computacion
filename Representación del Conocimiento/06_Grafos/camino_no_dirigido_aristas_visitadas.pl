% ===================================================================
% Ejercicio: camino_no_dirigido_aristas_visitadas.pl
% Descripcion: Encuentra caminos en un grafo no dirigido evitando ciclos mediante el control de aristas, pero devolviendo los vertices del camino.
