% ===================================================================
% Ejercicio: camino_no_dirigido_aristas.pl
% Descripcion: Encuentra caminos en un grafo no dirigido controlando las aristas ya visitadas y devolviendo la secuencia de aristas.
