...
import QLearning.qLearningGear;
import champ2011client.Action;
import champ2011client.SensorModel;

public class DriverGearTrain extends Controller{
	
    private qLearningGear gearAgent = new qLearningGear();
	...
	public void shutdown() {
	    ...
	    gearAgent.saveQTableCSV();  // guardar Q-table al final

	}
	
	
	private int getGear(SensorModel sensors) {
        return gearAgent.chooseGear(sensors);
    }
