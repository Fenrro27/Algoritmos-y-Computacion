...
std::vector<int> P1_2B_Busqueda::generarVectorAleatorio(int n, std::mt19937& gen) {
...
bool P1_2B_Busqueda::busquedaSecuencial(const std::vector<int>& vec, int target) {
    for (int num : vec) {
        if (num == target) {
            return true;
        }
...
void P1_2B_Busqueda::ejecutarExperimento(const std::string& nombreArchivo, int minN, int maxN, int paso, int repeticiones) {
