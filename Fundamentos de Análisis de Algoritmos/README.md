...
* **Solución de Visual Studio**: [FAA_P1,2,3.sln](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P1,2,3/FAA_P1,2,3.sln)
* **Código Fuente**: [FAA_P1,2,3/](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P1,2,3/FAA_P1,2,3/)

Contiene las prácticas 1, 2 y 3 implementadas en un proyecto de consola de C++. Su menú principal en [main.cpp](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P1,2,3/FAA_P1,2,3/main.cpp) permite ejecutar los experimentos para cada una:
...
* **Iterativo**: Multiplicaciones sucesivas con coste temporal lineal $O(n)$ y $O(n)$ OE ([P2_1_Potencia](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P1,2,3/FAA_P1,2,3/P2_1_Potencia.cpp)).
* **Recursivo**: Llamadas recursivas con coste temporal lineal $O(n)$ y $O(n)$ OE ([P2_2_PotenciaRec](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P1,2,3/FAA_P1,2,3/P2_2_PotenciaRec.cpp)).
* **Divide y Vencerás**: Exponenciación binaria recursiva que reduce la complejidad temporal a coste logarítmico $O(\log n)$ ([P2_3_PotenciaDV](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P1,2,3/FAA_P1,2,3/P2_3_PotenciaDV.cpp)).

### 📈 Práctica 3: Análisis Teórico y Recurrencias
Simulación analítica para comparar el ritmo de crecimiento de dos algoritmos $A_1$ y $A_2$ modelados mediante ecuaciones de recurrencia en [P3_FAA.cpp](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P1,2,3/FAA_P1,2,3/P3_FAA.cpp):
* **Algoritmo $A_1$**:
...
## 📁 2. Solución `FAA_P4`
* **Solución de Visual Studio**: [FAA_P4.sln](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P4/FAA_P4.sln)
* **Código Fuente del Proyecto**: [Algoritmica/](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P4/Algoritmica/)
...
* **Generación de Datos**: [GenerarVectores](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P4/Algoritmica/GenerarVectores.cpp) genera vectores con distribuciones uniformes o personalizadas.
* **Algoritmos Empíricos**: Implementados en [AlgoritmosEmpiricos.cpp](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P4/Algoritmica/AlgoritmosEmpiricos.cpp):
  * **Ordenación**:
...
* **Controlador de Tests**: [TestAlgoritmos.cpp](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P4/Algoritmica/TestAlgoritmos.cpp) permite ejecutar pruebas de corrección, obtener costes del caso medio, realizar comparaciones directas de dos métodos o evaluar el rendimiento según la distribución de los vectores (uniformes vs sesgados). También incluye el experimento de calibración del umbral óptimo $K$ para el MergeSort Híbrido.

### 📊 Análisis de Resultados y Gráficas
* **Carpeta de Resultados**: [resultados/](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P4/Algoritmica/resultados/)
* **Script de Visualización**: [Graficas.py](file:///c:/Users/kjba2/Documents/Algoritmos-y-Computacion/Fundamentos%20de%20An%C3%A1lisis%20de%20Algoritmos/FAA_P4/Algoritmica/resultados/Graficas.py)
