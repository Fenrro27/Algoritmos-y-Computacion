...
public class ArchivosTSP {
    ...
    public static void crearTour(Resultados r, String nombre) {

        FileWriter fichero = null;

        try {

            fichero = new FileWriter("src/FicherosTSP/" + nombre + ".opt.tour");
            // Escribimos linea a linea en el fichero

            fichero.write("NAME: " + nombre + "\n");
            fichero.write("TYPE: TOUR\n");
            fichero.write("DIMENSION: " + r.getDimension() + "\n");
            fichero.write("SOLUTION: " + r.getCosteTotal());
            fichero.write("\nTOUR_SECTION\n");
            fichero.write(r.getStringCamino());
            fichero.write(r.getCostArist());
            fichero.write("EOF\n");
            //cerramos el fichero una vez escrito
            fichero.close();
        } catch (IOException ex) {
