...
public class Practica_04_exe {
    ...
    public static void main(String[] args) {
        ...
        String p1 = "si2026.kevinjesusbandaalu.p07.Jugador1";
        ...
        System.out.println("======================================================================");
        System.out.println(
                String.format("%-10s | %-12s | %-12s | %-12s", "NIVEL", "% VICTORIA", "MEDIA PUNTOS", "MEDIA TICKS"));
        System.out.println("----------------------------------------------------------------------");
        ...
        for (int n = 0; n < 5; n++) {
            ...
            System.out.println(
                    String.format("Nivel %d    | %9.2f%%   | %12.2f | %12.2f", n, winRate, avgScore, avgTicks));
        }
